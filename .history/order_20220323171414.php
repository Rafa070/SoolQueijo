...
<section class="food-search">
    ...
    echo "<div class='error'>Imagem indisponível.</div>";
                ...
                ?>
                 <img src="<?php echo SITEURL; ?>images/food/<?php echo $image_name; ?>" alt="Lanche e" class="img-responsive img-curve"><?php
                }    
                  ?>
                   </div>
                    ...
                    <div class="order-label">Quantidade</div><input type="number" name="qty" class="input-responsive"value="1" required>
                </div>
            </fieldset>
            <fieldset>
