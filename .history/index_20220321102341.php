...
?><section class="food-search text-center">
    <div class="container">
        <form action="<?php echo SITEURL; ?>food-search.php" method="POST"><input type="search" name="search"
                placeholder="Pesquisar Comida" required><input type="submit" name="submit" value="Buscar"
...
if($count2>0) {
    ...
    while($row=mysqli_fetch_assoc($res2)) {
        ...
        ?></p><br><a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>"
                    class="btn btn-primary">Pedido</a>
            </div>
        </div><?php
    }
}
