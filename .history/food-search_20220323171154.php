...
<section class="food-search text-center">
    ...
    ?>
        <h2>Buscou por: <a href="#" class="text-white">"<?php echo $search; ?>"</a></h2>
    </div>
</section>
<section class="food-menu">
            ...
            <div class="food-menu-img"><?php if($image_name=="") {
              echo "<div class='error'>Imagem não encontrada</div>";
               ...
               ?>
                ...
                <img src="<?php echo SITEURL; ?>images/food/<?php echo $image_name; ?>" alt="Imagem de lanch"
       ...
       ?>
            ...
            <div class="food-menu-desc">
              ...
              ?>
                ...
                <br>
                <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="btn btn-primary">Comprar</a>
            </div>
        </div>
        <?php
    }
    ...
    echo "<div class='error'>Lanche não encontrado.</div>";
}
?>
    </div>
