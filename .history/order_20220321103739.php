                            ...
                            <div class="order-label">Email</div>
                               <input type="email" name="email" placeholder="soolqueijo@ifrn.edu.br" class="input-responsive" required>
                                  <div class="order-label">Endereço</div>
                                    <textarea name="address" rows="10" placeholder="Rua SoolQueijo, Canguaretama - RN" class="input-responsive" required></textarea><inputtype="submit" name="submit" value="Confirma Pedido" class="btn btn-primary">
            </fieldset>
        </form>
    </div>
